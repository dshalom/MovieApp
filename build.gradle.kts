...
subprojects {
    ...
    detekt {
        ...
        config.setFrom("${project.rootDir}/config/detekt_run.yaml/detekt_run.yaml.yml") // point to your custom config defining rules to run, overwriting default behavior
        baseline =
